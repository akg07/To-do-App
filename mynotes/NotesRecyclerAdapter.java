...
public class NotesRecyclerAdapter extends FirestoreRecyclerAdapter<Note, NotesRecyclerAdapter.NoteViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull NoteViewHolder holder, int position, @NonNull Note model) {
        ...
        holder.dataTextView.setText(dateCharSeq);
    }
    ...
    class NoteViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView noteTextView, dataTextView;
        CheckBox checkBox;
        ...
        public NoteViewHolder(@NonNull View itemView) {
            ...
            dataTextView = itemView.findViewById(R.id.date_text_view);
            ...
            checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (note.getCompleted() != isChecked) {
                        noteListener.handelCheckChanged(isChecked, documentSnapshot);
                    }
                }
            });
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    noteListener.handelEditNote(snapshot);
                }
            });
        }
        public void deleteItem() {
            noteListener.handelDeleteItem(getSnapshots().getSnapshot(getAdapterPosition()));
    ...
    interface NoteListener {
        ...
        public void handelEditNote(DocumentSnapshot snapshot);
